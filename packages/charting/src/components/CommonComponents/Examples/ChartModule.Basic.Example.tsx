...
import { IChartProps } from '@uifabric/charting'; // change imports
...
export class ChartModuleBasicExample extends React.Component<{}, IChartState> {
  ...
  private _basicExample(): JSX.Element {
    ...
    return (
      <>
        ...
        <div style={rootStyle}>
          <ChartModuleBase data={data} height={this.state.height} width={this.state.width} margins={margins} />
        </div>
      </>
    );
  }
